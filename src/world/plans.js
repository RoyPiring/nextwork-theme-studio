...
(function () {
  ...
  const capitalBuilds = [C('capitol', 28, 52), C('cityhall', 35, 51), C('library', 26, 51), C('park', 22, 51)];
  ...
  const PLANS = [
    { id: 'campground', name: 'Campground', word: 'a campground', threshold: 0,
      ...
      builds: [C('pump', 28, 34), C('foodcache', 33, 35), C('woodshed', 28, 35), C('lantern', 31, 35)], capacity: 2,
      lots: [row(32, 33, 33, 'south'), row(32, 36, 36, 'south'), row(34, 34, 34, 'north')],
    ...
    { id: 'kingdom', name: 'Kingdom', word: 'a kingdom', threshold: 120,
      ...
      civic: capitalBuilds.concat(capitalCivic), builds: [C('palace', 50, 30), C('townhall2', 50, 34)], capacity: 30, lots: capitalLots,
      landscape: { fields: FARMS, treeline: 'thin', lamps: 'all' } }
  ];
