...
(function () {
  ...
  B.pine = function (I, gx, gy, size) { size = size || 1; const b = I.p(gx + 0.5, gy + 0.5); I.ctx.fillStyle = 'rgba(20,40,30,.25)'; I.ctx.beginPath(); I.ctx.ellipse(b[0] + 5, b[1] + 2, 10 * size, 4 * size, 0, 0, Math.PI * 2); I.ctx.fill(); I.ctx.fillStyle = '#5a3a1e'; I.ctx.fillRect(b[0] - 2, b[1] - 12 * size, 4, 12 * size); [[0, 12, 14], [1, 22, 11], [2, 31, 8]].forEach(t => { I.poly([[b[0] - t[2] * size, b[1] - t[1] * size + 8 * size], [b[0] + t[2] * size, b[1] - t[1] * size + 8 * size], [b[0], b[1] - t[1] * size - 6 * size]], ['#2f6b3a', '#3a7f46', '#4a9452'][t[0]]); }); };
